...
echo "dch-p   $(dpkg -s dch-p | grep -i version)"
...
echo "nodejs    $(dpkg -s nodejs | grep -i version)"
...
# Check NVIDIA driver
echo -e "CHECKING NVIDIA DRIVER:\n"
if nvidia-smi &>/dev/null; then
    echo -e "NVIDIA driver is installed and active.\n"
else
    echo -e "NVIDIA driver is not installed.\n"
fi
